...
export class PortfolioService {
  ...
  getAllActivities(): Activity[] {
    return [
      ...
      {
        id: 4,
        title: 'Stage bij Cubigo',
        date: 'Februari - Mei 2026',
        type: 'Stage'
      },
      {
        id: 5,
        title: '.NET Aspire Workshop',
        date: 'Maart 2026',
        type: 'Workshop'
      },
      {
        id: 6,
        title: 'Low-code Development Seminar',
        date: 'April 2026',
        type: 'Seminar'
      }
    ];
    ...
    return [
      {
        ...
        date: 'Oktober 2025',
        type: 'Internationale samenwerking',
        description: 'Tijdens de Bus-IT week in Cardiff heb ik in een internationale, multidisciplinaire context kunnen functioneren. Deze ervaring heeft mijn communicatieve vaardigheden in het Engels aanzienlijk verbeterd en mij laten zien hoe belangrijk culturele diversiteit is in IT-projecten.',
        learnings: [
